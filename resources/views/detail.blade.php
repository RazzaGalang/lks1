...
<html lang="en">
    <head>
        ...
        <link href="{{asset('css/detailstyles.css')}}" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <!-- Navigation-->
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="small mb-1">ID Produk :</div>
                        <h1 class="display-5 fw-bolder">Nama Produk</h1>
                        <div class="fs-5 mb-5">
                            <span>$5.00</span>
                        </div>
        ...
        <!-- Core theme JS-->
        <script src="{{asset('detailassets/js/scripts.js')}}"></script>
    </body>
</html>
